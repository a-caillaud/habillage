package fr.inti.habillage.repository;

import fr.inti.habillage.HabillageApp;
import fr.inti.habillage.config.Constants;
import fr.inti.habillage.config.audit.AuditEventConverter;
import fr.inti.habillage.domain.PersistentAuditEvent;
...
import static fr.inti.habillage.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
